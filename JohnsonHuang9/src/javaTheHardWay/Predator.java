...
public class Predator extends ReproductionAnimal {
	...
	//1.It returns a predator using the constructor
	//2. There is a 50 50 chance of the predator eating a prey. If there is more
	//prey, there is a higher chance of the predator being able to eat, and if there is less
	//there is a lower chance
}
